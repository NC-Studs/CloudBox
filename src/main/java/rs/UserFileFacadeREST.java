...
@Stateless
@Path("userfile")
public class UserFileFacadeREST extends AbstractFacade<UserFile> {

    @PersistenceContext(unitName = "nc_cloudbox2_war_1.0-SNAPSHOTPU")
    private EntityManager em;

    public UserFileFacadeREST() {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, UserFile entity) {
        super.edit(entity);
    }
    ...
    public UserFile find(@PathParam("id") BigDecimal id) {
